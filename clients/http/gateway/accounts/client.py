...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    def open_debit_card_account(self, request: OpenDebitCardAccountRequestDict) -> Response:
        """
    ...
    def open_credit_card_account(self, request: OpenCreditCardAccountRequestDict) -> Response:
        """
